...
const Login = () => {
  ...
  const [generateCustomerToken, { data, loading, error }] =
    useMutation(GET_DOGS)
  ...
  return (
    <>
      <div className="h-20 flex items-center justify-between px-5">
        ...
        <div className="avatar w-[290px] flex justify-end items-center"></div>
      </div>
      <div className="container mx-auto mt-7 flex flex-col items-center justify-center">
        ...
        <div className="p-10 shadow-lg">
          ...
          <form className="" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="px-5 flex justify-between items-center flex-col lg:flex-row">
          ...
          <Link href="/signup">
            <a className=" text-base font-medium flex justify-center items-center">
              ...
              <span className="text-blue-400 ml-[15px]">Sign Up</span>
            </a>
          </Link>
        </div>
      </div>
